  ...
  <Edit {...props}>
    <SimpleForm>
      ...
      <ReferenceInput
        ...
        // filter={{ isAdmin: true }}
      >
        <SelectInput label="ユーザー" optionText="名" />
      </ReferenceInput>
      <FileInput source="files_multiple" multiple label="複数）のファイル">
        <FileField source="src" title="タイトル" />
      </FileInput>
      <ArrayInput source="files">
        <SimpleFormIterator>
          <FileInput source="file" label="Array Form Files">
      ...
      <ArrayInput source="sections.mySection.items" label="セクションアイテム">
        <SimpleFormIterator>
          <TextInput source="name" label="名" />
          <ImageInput source="image" label="イメージ" accept="image/*">
            <ImageField source="src" title="タイトル" />
          </ImageInput>
        </SimpleFormIterator>
      </ArrayInput>
    </SimpleForm>
